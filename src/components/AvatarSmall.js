...
export default function AvatarSmall(props){
    ...
    if(avatarSrc === 'no'){
        return(
            <div className="AvatarSmall hidden" style={{background:'var(--primary)'}} data-clicked={props.clicked} onClick={props.click}>
    ...
    return(
        <div className="AvatarSmall" style={{background:`center / contain no-repeat url(https://api.yundu.co/avatars/${avatarSrc})`}} data-clicked={props.clicked} onClick={props.click}></div>
    )
}   }